...
Аддон геймификации для Blender 4.5 / 5.0 / 5.1.
105 достижений, XP-система с 10 уровнями, награды, уроки.

---

## Установка

### Вариант 1 — ZIP (рекомендуется)
1. `Edit → Preferences → Add-ons → Install from Disk...`
2. Выбрать файл `blender_achievements_addon_v01.zip`
3. Включить галочку «Achievements»

### Вариант 2 — Одиночный .py файл
1. `Edit → Preferences → Add-ons → Install from Disk...`
2. Выбрать файл `__init__.py` (переименовав в `blender_achievements.py`)
3. Включить галочку «Achievements»
