...
`Achievements` is currently a Blender add-on with a root runtime entrypoint, pure catalog/engine/event/lifecycle/persistence/rewards/ui helper modules, and a byte-identical tracked duplicate of the root entrypoint.
